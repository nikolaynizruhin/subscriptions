<template>
    <div class="flex flex-col min-h-screen">
        <header class="flex shadow">
            ...
            <div class="hidden border-gray-800 bg-gray-800 sm:border-gray-300 sm:bg-white border-b flex-grow px-6 py-3 sm:flex justify-end">
                <div class="hidden sm:block relative">
                    ...
                    <button type="button" class="flex items-center focus:outline-none" @click="isOpen = !isOpen">
        ...
        <div class="flex flex-grow">
            <div v-if="isOpenMenu" @click="isOpenMenu = false" class="fixed inset-0"></div>
            <aside :class="isOpenMenu ? 'absolute h-full' : 'hidden'" class="gradient sm:block w-56 p-4 text-gray-300">
